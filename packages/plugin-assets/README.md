...
_See code: [src/commands/assets/init.js](https://github.com/twilio-labs/serverless-toolkit/blob/v0.1.0-beta.1/src/commands/assets/init.js)_
...
_See code: [src/commands/assets/list.js](https://github.com/twilio-labs/serverless-toolkit/blob/v0.1.0-beta.1/src/commands/assets/list.js)_
...
_See code: [src/commands/assets/upload.js](https://github.com/twilio-labs/serverless-toolkit/blob/v0.1.0-beta.1/src/commands/assets/upload.js)_
<!-- commandsstop -->
