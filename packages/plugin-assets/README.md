...
_See code: [src/commands/assets/init.js](https://github.com/twilio-labs/serverless-toolkit/blob/v2.0.1-beta.0/src/commands/assets/init.js)_
...
_See code: [src/commands/assets/list.js](https://github.com/twilio-labs/serverless-toolkit/blob/v2.0.1-beta.0/src/commands/assets/list.js)_
...
_See code: [src/commands/assets/upload.js](https://github.com/twilio-labs/serverless-toolkit/blob/v2.0.1-beta.0/src/commands/assets/upload.js)_
<!-- commandsstop -->
